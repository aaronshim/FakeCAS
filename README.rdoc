...
* <tt>GET /proxyValidate?service-some_url&ticket=12345-67890-12345-67890</tt> - Hacky CAS 2.0 feature that as of now gives an approval for anything as long as the ticket is found.

I am currently trying to hack in some features of CAS 2.0 to make this usable for my own projects. I am following the CAS 2.0 and 3.0 spec followed here.[http://jasig.github.io/cas/development/protocol/CAS-Protocol-Specification.html]
